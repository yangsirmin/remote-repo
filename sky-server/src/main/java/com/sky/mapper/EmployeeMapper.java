...
public interface EmployeeMapper {
     ...
     * @return
     */
    @Select("select count(*) from sky_take_out.employee where id = #{id} and password = #{password}")
    Integer selectPassword(Employee employee);

    /**
     * 根据id修改密码
     * @param employee
     */
    @Update("update sky_take_out.employee set password = #{password} where id = #{id}")
