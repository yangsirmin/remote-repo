...
//        );
    ...
    public PageResult pageQuery4User(int pageNum, int pageSize, Integer status) {
        ...
        if (page != null && page.getTotal() > 0) {
            for (Orders orders : page) {
                ...
                // 查询订单明细
                List<OrderDetail> orderDetails = orderDatilsMapper.getByOrderId(orderId);
    ...
    public OrderVO details(Long id) {
        ...
        // 查询该订单对应的菜品/套餐明细
        List<OrderDetail> orderDetailList = orderDatilsMapper.getByOrderId(orders.getId());
    ...
    public void repetition(Long id) {
        ...
        // 根据订单id查询当前订单详情
        List<OrderDetail> orderDetailList = orderDatilsMapper.getByOrderId(id);
